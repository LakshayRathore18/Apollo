// This file defines the data structure and content for the "Quick Actions" panel on the dashboard, which provides users with pre-filled text prompts to quickly generate AI voices for different use cases.
